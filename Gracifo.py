...
import pandas as pd #(version 0.24.2) #Utilizado para la lectura del archivo de excel
import datetime as dt
import dash         #(version 1.0.0) #Para el html interactivo
from dash import dcc
from dash import html
from dash.dependencies import Input, Output

import plotly       #(version 4.4.1) #Para lo interactivo y grafico de barras
